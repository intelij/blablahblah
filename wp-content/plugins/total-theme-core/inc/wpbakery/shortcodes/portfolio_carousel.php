...
if ( ! class_exists( 'VCEX_Portfolio_Carousel_Shortcode' ) ) {
	...
	class VCEX_Portfolio_Carousel_Shortcode {
		 ...
		 */
		public $shortcode = 'vcex_portfolio_carousel';
		...
		public function vc_after_mapping() {
			...
			if ( 'vc_get_autocomplete_suggestion' === $vc_action || 'vc_edit_form' === $vc_action ) {
				...
				add_filter( 'vc_autocomplete_' . $this->shortcode .'_include_categories_callback', 'vcex_suggest_portfolio_categories' );
				add_filter( 'vc_autocomplete_' . $this->shortcode .'_exclude_categories_callback', 'vcex_suggest_portfolio_categories' );

				// Render autocomplete suggestions
				add_filter( 'vc_autocomplete_' . $this->shortcode .'_include_categories_render', 'vcex_render_portfolio_categories' );
				add_filter( 'vc_autocomplete_' . $this->shortcode .'_exclude_categories_render', 'vcex_render_portfolio_categories' );
